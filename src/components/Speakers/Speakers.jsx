    ...
    <div id='speakers' className="bg-red text-white py-5">
      ...
      <div className="flex flex-col md:flex-row justify-evenly">
        <SpeakerCard
          ...
          linkedinUrl={"https://www.linkedin.com/in/athul-cyriac-ajay"}
        />
        <SpeakerCard
          name={"Andrew Bastin"}
          designation={"CTO, Hoppscotch"}
          linkedinUrl={"https://www.linkedin.com/in/andrew-bastin-7456771a8/"}
        />
        <SpeakerCard
          name={"Abraham Raji"}
          designation={"Debian Developer"}
          linkedinUrl={"https://www.linkedin.com/in/avronr/"}
        />
      </div>
    </div>
  );
...
const SpeakerCard = ({ name, designation, img, linkedinUrl }) => {
  return (
